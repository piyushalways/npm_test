...
// #define TEST_RGB_LEDS      //red led not working
// #define TEST_GPIO1_GPIO2   //done
// #define TEST_GPIO3         //done  
// #define TEST_VOUT1         //done (able to enable disable but voltage id not varying much in blink)
// #define TEST_LS1			  //done same as above
// #define TEST_LS2 		  //done same as above
...
int main(void)
{
    ...
    printk("  Version: 1.2 (with GPIO support)\n");
    printk("========================================\n\n");
    ...
    /* Run selected test(s) */
#ifdef TEST_RGB_LEDS
    printk("\n=== Running RGB LED Test Continuously ===\n");
...
#ifdef TEST_GPIO1_GPIO2
    printk("\n=== Running GPIO1/GPIO2 Test Continuously ===\n");
    printk("Press reset to stop\n\n");
    while (1) {
        test_gpio1_gpio2();
        k_msleep(1000);
...
#ifdef TEST_GPIO3
    printk("\n=== Running GPIO3 Test Continuously ===\n");
    printk("Press reset to stop\n\n");
    while (1) {
        test_gpio3();
        k_msleep(1000);
